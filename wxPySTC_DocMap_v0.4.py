...
#TODO, styling now tightly coupled with DocumentEditor!
    ...
    def LeftDown(self, evt):
        ...
        top_y = round(clicked_line * self.GetDocScrollRatio())
    ...
    def DocPosChanged(self, evt):
        ...
        self.CalcHeights()
        top_y = round(self.doc.FirstVisibleLine * self.GetDocScrollRatio())
    ...
    def GetTopLine(self, top_y):
        top_line = round(top_y / self.scroll_height * (self.LineCount - self.LinesOnScreen()))
        return top_line
